...
```{r fire bar, eval=FALSE, echo=FALSE, message=FALSE, warning=FALSE, fig.width=10, fig.height=10}
...
```{r all disturbances, eval=FALSE, echo=FALSE, message=FALSE, warning=FALSE, out.width="100%"}
