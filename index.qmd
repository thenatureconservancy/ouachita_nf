...
* Provide context for the past and present ecosystem conditions the Ouachita National Forest.
...
* All maps, input datasets and further assistance can be obtained by contacting the author, [Randy Swaty](mailto:rswaty@tnc.org){target="blank"} and [Melanie Rudolf](mailto:melanie.rudolf@tnc.org), Nature Conservancy Ecologists.
* Review is ongoing.
